    ...
    public class NavigationService : INavigationService
    {
        ...
        public async Task OpenAsync(Type page, object parameter = null, string title = null, ViewSizePreference size = ViewSizePreference.UseHalf)
        {
            ...
            await dispatcher.RunAsync(async () =>
            {
                ...
                var frame = BootStrapper.Current.NavigationServiceSetup(BootStrapper.BackButton.Ignore, BootStrapper.ExistingContent.Exclude, new Frame());
        ...
        */
        ...
        public bool Navigate<T>(T key, object parameter = null, bool clearBackStack = false, NavigationTransitionInfo infoOverride = null)
