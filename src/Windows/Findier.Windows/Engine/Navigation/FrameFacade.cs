...
namespace Findier.Windows.Engine.Navigation
{
    ...
    public class FrameFacade
    {
        ...
        private global::Windows.Storage.ApplicationDataContainer _frameStateContainer;
        private global::Windows.Storage.ApplicationDataContainer FrameStateContainer()
        {
            ...
            _frameStateContainer = data.LocalSettings.CreateContainer(key, global::Windows.Storage.ApplicationDataCreateDisposition.Always);
            return _frameStateContainer;
        }
        ...
        public IPropertySet PageStateContainer(Type type)
        {
            ...
            var container = FrameStateContainer().CreateContainer(key, global::Windows.Storage.ApplicationDataCreateDisposition.Always);
        ...
        public void Refresh()
        {
            ...
            try
            {
                global::Windows.ApplicationModel.Resources.Core.ResourceContext.GetForCurrentView().Reset();
