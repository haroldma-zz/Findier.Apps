...
namespace Findier.Windows.Engine.Navigation
{
    public interface INavigationService
    {
        ...
        void GoBack();
        void GoForward();
        bool Navigate(Type page, object parameter = null, bool clearBackStack = false, NavigationTransitionInfo infoOverride = null);
        bool Navigate<T>(T key, object parameter = null, bool clearBackStack = false, NavigationTransitionInfo infoOverride = null) where T : struct, IConvertible;
