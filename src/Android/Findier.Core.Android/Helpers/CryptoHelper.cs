...
namespace Findier.Core.Android.Helpers
{
    /// <summary>
    ///     The <see cref="CryptoHelper" /> provides an easy way encrypt and decrypt
    ...
    internal static class CryptoHelper
    {
        ...
        private static readonly byte[] Salt = Encoding.ASCII.GetBytes("SquanchAllTheSalts!");
